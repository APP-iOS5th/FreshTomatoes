            ...
            NavigationStack {
                ScrollView {
                    VStack {
                        ...
                        TitleView(semiTitle: "", title: "ALL MOVIE", buttonTitle: "View all", movies: homeVM.allMovies, allViewImageWidth: geometry.size.width * 0.27, allViewImageHeight: geometry.size.height * 0.21, detailViewWidth: geometry.size.width, detailViewHeight: geometry.size.height * 0.4)
                            .padding(.horizontal)
